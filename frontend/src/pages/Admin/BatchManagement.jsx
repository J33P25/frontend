...
//       const deptRes = await api.get("/admin/depts");
...
//     <div>
//       <h3>Add Batch</h3>
//       <form onSubmit={handleSubmit} style={{ ...formStyle, flexWrap: "wrap" }}>
//         <select
//           style={inputStyle}
...
//           {batches.map((b) => (
//             <tr key={b.id}>
//               <td style={tdStyle}>{b.batch_name}</td>
...
// const inputStyle = { padding: "10px", border: "1px solid #ddd", borderRadius: "4px", flex: "1 0 150px" };
