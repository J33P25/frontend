...
// import ViewTimeTable from "./ViewTimeTable"; // The Landing Page
// import TimetableConfig from "./TimetableConfig"; // The Creator Page
// import AttendanceOverview from "./AttendanceOverview";
// import AttendanceShortage from "./AttendanceShortage";
// import Reports from "./Reports";

// const AdminDashboard = () => {
//   // LANDING PAGE IS NOW TIMETABLE VIEW
...
//           <button style={navBtn(activeSection === "view_timetable")} onClick={() => setActiveSection("view_timetable")}>
//              View Timetable (Home)
//           </button>
//           <button style={navBtn(activeSection === "config_timetable")} onClick={() => setActiveSection("config_timetable")}>
//              Configure Slots
//           </button>

//           <small style={{ color: "#ffcccb", fontWeight: "bold", marginTop: "10px" }}>ACADEMICS</small>
//           <button style={navBtn(activeSection === "departments")} onClick={() => setActiveSection("departments")}>
//             Departments
//           </button>
//           <button style={navBtn(activeSection === "batches")} onClick={() => setActiveSection("batches")}>
//             Batches
//           </button>
//           <button style={navBtn(activeSection === "sections")} onClick={() => setActiveSection("sections")}>
//             Sections
//           </button>
...
import BatchManagement from "./BatchManagement";
import SectionManagement from "./SectionManagement";
import StudentManagement from "./StudentManagement"; // NEW IMPORT
import SubjectManagement from "./SubjectManagement";
    ...
    <div style={{ display: "flex", height: "100%", minHeight: "100vh" }}>
      ...
      <aside style={{ width: "260px", backgroundColor: "#AD3A3C", color: "white", padding: "20px", display: "flex", flexDirection: "column" }}>
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          <small style={{ color: "#ffcccb", fontWeight: "bold", marginTop: "10px" }}>TIMETABLE</small>
          <button style={navBtn(activeSection === "view_timetable")} onClick={() => setActiveSection("view_timetable")}>View Timetable (Home)</button>
...
const getSectionTitle = (key) => {
  switch (key) {
    case "view_timetable": return "Class Timetable Viewer";
    case "config_timetable": return "Configure Timetable Slots";
    case "students": return "Student Directory"; // New Title
    case "users": return "User & Role Management";
    case "departments": return "Department Configuration";
    case "batches": return "Batch Configuration";
    case "sections": return "Section Configuration";
...
const renderSection = (key) => {
  switch (key) {
    case "view_timetable": return <ViewTimeTable />;
    case "config_timetable": return <TimetableConfig />;
    case "students": return <StudentManagement />; // New Component
    case "users": return <UserManagement />;
    case "departments": return <DepartmentManagement />;
    case "batches": return <BatchManagement />;
    case "sections": return <SectionManagement />;
