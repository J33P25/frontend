...
//   // --- CONTEXT STATE (Where are we working?) ---
...
//   // 2. Cascade Dropdowns (Batch/Section)
//   useEffect(() => {
//     if (selectedDept) {
...
//   // 3. Auto-Fetch Timetable when context changes
//   useEffect(() => {
...
//       fetchTimetable(); // Refresh grid instantly
//       alert("Slot Added");
//     } catch (e) {
...
//         <span style={{fontWeight:'bold', marginRight:10}}>Editing For: </span>
...
//         {/* LEFT: PREVIEW GRID */}
//         <div style={{ flex: 3, border: "1px solid #ddd", borderRadius: "8px", padding: "15px", overflow: "auto" }}>
//           <h4 style={{ marginTop: 0, color: "#AD3A3C" }}>Live Preview</h4>
//           {selectedSection ? (
...
//         {/* RIGHT: ADD SLOT FORM */}
//         <div style={{ flex: 1, background: "#f9f9f9", padding: "20px", borderRadius: "8px", border: "1px solid #eee" }}>
...
//             <select style={inputStyle} value={formData.faculty_id} onChange={e=>setFormData({...formData, faculty_id: e.target.value})} required>
...
//                 return (
//                   <td key={slot} style={{ ...tdStyle, background: entry ? "#fff" : "#fafafa" }}>
//                     {entry ? (
//                       <div style={{ position: "relative" }}>
//                         <div style={{ fontWeight: "bold", color: "#333" }}>{entry.course_name.substring(0, 15)}...</div>
//                         <div style={{ color: "#666", fontSize: "11px" }}>{entry.faculty_name}</div>
//                         <button 
//                             onClick={() => onDelete(entry.id)}
//                             style={{ position: "absolute", top: "-5px", right: "-5px", background: "red", color: "white", border: "none", borderRadius: "50%", width: "16px", height: "16px", fontSize: "10px", cursor: "pointer" }}
//                         >x</button>
//                       </div>
//                     ) : (
...
// const thStyle = { background: "#666", color: "white", padding: "8px", fontSize: "12px" };
// const tdStyle = { border: "1px solid #ddd", padding: "8px", textAlign: "center", height: "50px", verticalAlign: "middle" };
...
// // --- INTERACTIVE GRID COMPONENT (9 SLOTS) ---
// const InteractiveGrid = ({ data, onDelete }) => {
//     const days = ["Mon", "Tue", "Wed", "Thu", "Fri"];
//     // UPDATED TO 9 SLOTS
...
//                     {entry ? (
//                       <div>
//                         <div style={{ fontWeight: "bold", color: "#333", fontSize:"10px", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
//                           {entry.course_name}
//                         </div>
